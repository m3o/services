...
func (c *onboardingService) SetPaymentMethod(ctx context.Context, in *SetPaymentMethodRequest, opts ...client.CallOption) (*SetPaymentMethodResponse, error) {
...
func (c *onboardingService) HasPaymentMethod(ctx context.Context, in *HasPaymentMethodRequest, opts ...client.CallOption) (*HasPaymentMethodResponse, error) {
...
func (c *onboardingService) CompleteSignup(ctx context.Context, in *CompleteSignupRequest, opts ...client.CallOption) (*CompleteSignupResponse, error) {
...
func (c *onboardingService) Recover(ctx context.Context, in *RecoverRequest, opts ...client.CallOption) (*RecoverResponse, error) {
...
func (c *onboardingService) ResetPassword(ctx context.Context, in *ResetPasswordRequest, opts ...client.CallOption) (*ResetPasswordResponse, error) {
...
func (h *onboardingHandler) SetPaymentMethod(ctx context.Context, in *SetPaymentMethodRequest, out *SetPaymentMethodResponse) error {
	return h.SignupHandler.SetPaymentMethod(ctx, in, out)
}

func (h *onboardingHandler) HasPaymentMethod(ctx context.Context, in *HasPaymentMethodRequest, out *HasPaymentMethodResponse) error {
	return h.SignupHandler.HasPaymentMethod(ctx, in, out)
}

func (h *onboardingHandler) CompleteSignup(ctx context.Context, in *CompleteSignupRequest, out *CompleteSignupResponse) error {
	return h.SignupHandler.CompleteSignup(ctx, in, out)
}

func (h *onboardingHandler) Recover(ctx context.Context, in *RecoverRequest, out *RecoverResponse) error {
	return h.SignupHandler.Recover(ctx, in, out)
}

func (h *onboardingHandler) ResetPassword(ctx context.Context, in *ResetPasswordRequest, out *ResetPasswordResponse) error {

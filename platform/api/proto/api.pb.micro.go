...
type PlatformService interface {
	...
	Traces(ctx context.Context, in *TracesRequest, opts ...client.CallOption) (*TracesResponse, error)
...
func (c *platformService) Logs(ctx context.Context, in *LogsRequest, opts ...client.CallOption) (*LogsResponse, error) {
	req := c.c.NewRequest(c.name, "Platform.Logs", in)
...
func (c *platformService) Traces(ctx context.Context, in *TracesRequest, opts ...client.CallOption) (*TracesResponse, error) {
	req := c.c.NewRequest(c.name, "Platform.Traces", in)
...
func (c *platformService) Stats(ctx context.Context, in *StatsRequest, opts ...client.CallOption) (*StatsResponse, error) {
	req := c.c.NewRequest(c.name, "Platform.Stats", in)
...
type PlatformHandler interface {
	...
	Traces(context.Context, *TracesRequest, *TracesResponse) error
...
func RegisterPlatformHandler(s server.Server, hdlr PlatformHandler, opts ...server.HandlerOption) error {
	type platform interface {
		...
		Traces(ctx context.Context, in *TracesRequest, out *TracesResponse) error
...
func (h *platformHandler) Logs(ctx context.Context, in *LogsRequest, out *LogsResponse) error {
	return h.PlatformHandler.Logs(ctx, in, out)
}

func (h *platformHandler) Traces(ctx context.Context, in *TracesRequest, out *TracesResponse) error {
	return h.PlatformHandler.Traces(ctx, in, out)
}

func (h *platformHandler) Stats(ctx context.Context, in *StatsRequest, out *StatsResponse) error {
	return h.PlatformHandler.Stats(ctx, in, out)
}
